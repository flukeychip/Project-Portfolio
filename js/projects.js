...
const projects = [
  ...
  },
  {
    ...
    description: "This is the most in-depth project I have taken on. I was inspired by the Universal Robots UR3e arms in a campus design lab, but at $20,000 they were out of my price range, so I built my own. It was a huge learning experience, and I did a deep dive into reduction drives, backlash, inverse kinematics, leverage, closed-loop positioning and of course, robotics.</p><p>I had settled on 20:1 cycloidal drives (although my 3D printed versions are not without their flaws) for the base, shoulder and elbow axes, and servo motors for the wrist 1, 2 and 3. Additionally, I had remotely actuated the elbow axis to move the center of mass closer to the shoulder axis.</p><p>But, in my testing I found that my underpowered NEMA 17s were stalling and skipping steps, so I added Hall effect sensors for closed-loop control. If you look in the back right of the video, you will see an Nvidia Jetson, which is where my future plans for the robot arm come in.",
  ...
  },
  {
    id: "pantilt",
    name: "Pan-Tilt Mount",
    tagline: "Two-axis stepper-driven camera and sensor platform",
